...
export class Level {
  ...
  async _loadGLTFGeometry(url) {
    ...
    if (hasManualColliders) {
      ...
      console.log('⚙️ Auto-generating colliders from meshes');
      this._loadAutoGeneratedColliders(meshesToProcess);
    }
    
    console.log(`✅ GLTF processing complete: ${meshCount} meshes, ${this.physicsBodies.length} physics bodies`);
    console.log(`💡 Tip: Use the editor to create manual colliders for better collision control`);
  }
