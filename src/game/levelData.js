...
export const levels = [
  {
    ...
    lights: [ 'BasicLights' ],
    enemies: [
      { type: 'walker', position: [5, 6, 8], modelUrl: 'src/assets/low_poly_female/scene.gltf', patrolPoints: [[7,2,-8,0.5], [13,2,-8,0.5]], speed: 20, chaseRange: 5 },
      { type: 'runner', position: [10, 6, 6], modelUrl: 'src/assets/low_poly_male/scene.gltf', patrolPoints: [[12,2,6,0.4],[16,2,6,0.4]], speed: 30, chaseRange: 7 },
